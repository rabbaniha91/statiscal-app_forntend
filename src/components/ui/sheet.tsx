    ...
    <SheetPortal>
      ...
      >
        <SheetPrimitive.Close
          className={`absolute ${side === "right" ? "left-4" : "right-4"} top-4 rounded-sm opacity-70 ring-offset-white 
            transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 
            focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none
             data-[state=open]:bg-slate-100 dark:ring-offset-slate-950 dark:focus:ring-slate-300 dark:data-[state=open]:bg-slate-800`}
        >
          <X className="h-4 w-4" />
